...
class Tracker(object):
	...
	def update(self, detections):
		...
		if len(self.tracks) == 0:
			...
			for i in range(detections.shape[0]):
				# print (detections[i])
				# dictionaries.my_dictionarie.tracks_dict[i] = {}
				# dictionaries.my_dictionarie.tracks_dict[i]["coord_prev"]= {}
				# dictionaries.my_dictionarie.tracks_dict[i]["coord_pred"]= {}
				# dictionaries.my_dictionarie.tracks_dict[i]["coord_prev"]["x"] = detections[i][0]
				# dictionaries.my_dictionarie.tracks_dict[i]["coord_prev"]["y"] = detections[i][1]
				# dictionaries.my_dictionarie.tracks_dict[i]["counter"] = 0
				# dictionaries.my_dictionarie.tracks_dict[i]["coord_pred"]["x"] = None
				# dictionaries.my_dictionarie.tracks_dict[i]["coord_pred"]["y"] = None
				track = Tracks(detections[i], self.trackId)
				self.trackId +=1
				self.tracks.append(track)
			# for clave, valor in dictionaries.my_dictionarie.tracks_dict.items():
			# 	print (clave,";",valor)
